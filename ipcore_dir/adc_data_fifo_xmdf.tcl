...
package provide adc_data_fifo_xmdf 1.0
...
# is <core_name>_xmdf
namespace eval ::adc_data_fifo_xmdf {
...
# ::adc_data_fifo_xmdf::xmdfInit

# Function called by client to fill in all the xmdf* data variables
# based on the current settings of the parameters
proc ::adc_data_fifo_xmdf::xmdfApplyParams { instance } {
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path adc_data_fifo.ngc
utilities_xmdf::xmdfSetData $instance FileSet $fcount type ngc
incr fcount

utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path adc_data_fifo.v
utilities_xmdf::xmdfSetData $instance FileSet $fcount type verilog
incr fcount

utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path adc_data_fifo.veo
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount associated_module adc_data_fifo
incr fcount
