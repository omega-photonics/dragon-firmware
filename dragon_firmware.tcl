# 
# Project automation script for dragon_firmware 
# 
# Created for ISE version 14.2
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source dragon_firmware.tcl), then you can
...
set myProject "dragon_firmware"
set myScript "dragon_firmware.tcl"
...
proc add_source_files {} {
   ...
   xfile add "BMD_64_RX_ENGINE.v"
   xfile add "BMD_64_TX_ENGINE.v"
   xfile add "PCIe.ucf"
   xfile add "b8to64.v"
   xfile add "bmd_common/BMD.v"
   xfile add "bmd_common/BMD_CFG_CTRL.v"
   xfile add "bmd_common/BMD_EP.v"
   xfile add "bmd_common/BMD_EP_MEM.v"
   xfile add "bmd_common/BMD_EP_MEM_ACCESS.v"
   xfile add "bmd_common/BMD_INTR_CTRL.v"
   xfile add "bmd_common/BMD_RD_THROTTLE.v"
   xfile add "bmd_common/BMD_TO_CTRL.v"
   xfile add "ipcore_dir/clockdoubler.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/bram_common.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/cmm_decoder.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/cmm_errman_cnt_en.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/cmm_errman_cor.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/cmm_errman_cpl.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/cmm_errman_ftl.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/cmm_errman_ram4x26.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/cmm_errman_ram8x26.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/cmm_intr.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/endpoint_blk_plus_v1_14.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/extend_clk.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_cf.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_cf_arb.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_cf_err.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_cf_mgmt.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_cf_pwr.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_if.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_ll.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_ll_arb.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_ll_credit.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_ll_oqbqfifo.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_ll_tx.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_ll_tx_arb.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_plus_ll_rx.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_blk_plus_ll_tx.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_clocking.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_ep.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_gt_wrapper.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_gt_wrapper_top.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_gtx_wrapper.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_mim_wrapper.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_reset_logic.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_soft_int.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/pcie_top.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/prod_fixes.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/sync_fifo.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/tlm_rx_data_snk.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/tlm_rx_data_snk_bar.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/tlm_rx_data_snk_mal.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/tlm_rx_data_snk_pwr_mgmt.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/tx_sync_gtp.v"
   xfile add "ipcore_dir/endpoint_blk_plus_v1_14/source/tx_sync_gtx.v"
   xfile add "ipcore_dir/fifo_buffer_addresses.ngc"
   xfile add "ipcore_dir/fifo_buffer_addresses.v"
   xfile add "ipcore_dir/fifo_tlp_data.ngc"
   xfile add "ipcore_dir/fifo_tlp_data.v"
   xfile add "ipcore_dir/fifo_tlp_headers.ngc"
   xfile add "ipcore_dir/fifo_tlp_headers.v"
   xfile add "v5_blk_plus_pci_exp_64b_app.v"
   xfile add "xilinx_pci_exp_ep.v"

   # Set the Top Module as well...
   project set top "xilinx_pci_exp_ep"
...
proc set_process_props {} {
   ...
   project set "UserID Code (8 Digit Hexadecimal)" "0xabcdef42" -process "Generate Programming File"
   ...
   project set "Configuration Rate" "13" -process "Generate Programming File"
   ...
   project set "Work Directory" "/home/ii/code/omega/dragon-firmware/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "xilinx_pci_exp_ep" -process "Generate IBIS Model"
